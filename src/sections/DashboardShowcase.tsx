        ...
        >
          <GlassCard className="p-6 lg:p-8">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span
                        className={`flex items-center gap-0.5 text-xs font-semibold ${
                          stat.up ? 'text-mint' : 'text-rose-400'
                        }`}
                      >
                        {stat.up ? (
            ...
            <div className="grid lg:grid-cols-3 gap-4">
              ...
              <div className="rounded-xl bg-white/[0.03] border border-white/[0.06] p-6 flex flex-col justify-between">
                <div>
                  <p className="text-sm font-semibold text-ink-100 mb-4">Spending by Category</p>
                  <AnimatedPieChart
                    size={110}
                    data={[
                      { label: 'Food', value: 38, color: '#34D399' },
                      { label: 'Bills', value: 27, color: '#2DD4BF' },
                      { label: 'Transport', value: 18, color: '#10B981' },
                      { label: 'Other', value: 17, color: '#6EE7B7' },
                    ]}
                  />
                </div>
              </div>
