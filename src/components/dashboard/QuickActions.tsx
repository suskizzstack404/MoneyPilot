...
const actions = [
  { label: 'Add Income', to: '/dashboard/income', icon: PlusCircle, color: '#22C55E' },
  { label: 'Add Expense', to: '/dashboard/expenses', icon: MinusCircle, color: '#EF4444' },
  { label: 'Transfer', to: '/dashboard/transactions', icon: ArrowLeftRight, color: '#3B82F6' },
  { label: 'New Goal', to: '/dashboard/savings-goals', icon: Target, color: '#16A34A' },
  { label: 'Add Subscription', to: '/dashboard/subscriptions', icon: Repeat, color: '#4ADE80' },
]
