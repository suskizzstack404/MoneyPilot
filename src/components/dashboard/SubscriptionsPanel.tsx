        ...
        return (
          ...
          >
            <GlassCard hover className="p-4 flex items-center gap-3.5">
              <span className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center flex-shrink-0">
                ...
                {sub.next_renewal_date && (
                  <p
                    className={`text-xs mt-0.5 flex items-center gap-1 ${
                      isUrgent ? 'text-amber-600' : 'text-ink-500'
                    }`}
                  >
