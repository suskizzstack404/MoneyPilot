...
const severityStyles = {
  info: { icon: Sparkles, color: '#2DD4BF', bg: 'bg-teal/10', border: 'border-teal/25' },
  warning: { icon: AlertTriangle, color: '#FBBF24', bg: 'bg-amber-400/10', border: 'border-amber-400/25' },
  critical: { icon: AlertTriangle, color: '#F87171', bg: 'bg-rose-400/10', border: 'border-rose-400/25' },
} as const
