      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-5">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-full bg-white/[0.03] border border-white/[0.08] pl-9 pr-4 py-2.5 text-sm text-ink-100 placeholder:text-ink-500 outline-none focus:border-mint/40 transition-colors duration-200"
          />
        </div>
        <div className="flex items-center gap-1.5 bg-white/[0.03] border border-white/[0.08] rounded-full p-1">
          {(['all', 'income', 'expense'] as const).map((k) => (
            <button
              ...
              className={`px-3.5 py-1.5 rounded-full text-xs font-medium capitalize transition-colors duration-200 ${
                kindFilter === k ? 'bg-white/[0.08] text-ink-100' : 'text-ink-500 hover:text-ink-300'
              }`}
            >
              {k}
            </button>
        ...
        <>
          <div className="overflow-x-auto -mx-2">
            <table className="w-full text-sm min-w-[640px]">
              <thead>
                <tr className="text-left text-xs text-ink-500 border-b border-white/[0.06]">
                      ...
                      <td className="px-2 py-3.5">
                        <div className="flex items-center gap-2.5">
                          <span
                            ...
                            style={{
                              backgroundColor: `${t.category?.color ?? '#7C8798'}1A`,
                              color: t.category?.color ?? '#7C8798',
                            }}
                          >
