...
const variants: Record<string, string> = {
  primary:
    'bg-mint-emerald text-[#04140D] shadow-glow-sm hover:shadow-glow hover:-translate-y-0.5 active:translate-y-0',
  secondary:
    'glass text-ink-100 hover:bg-white/[0.08] hover:-translate-y-0.5 active:translate-y-0',
