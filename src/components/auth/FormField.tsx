        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full rounded-xl bg-white/[0.03] border ${
              error ? 'border-rose-400/60' : 'border-white/[0.08]'
            } px-4 py-3 text-sm text-ink-100 placeholder:text-ink-500 outline-none transition-all duration-200 focus:border-mint/50 focus:bg-white/[0.05] focus:shadow-glow-sm ${
              icon ? 'pl-11' : ''
